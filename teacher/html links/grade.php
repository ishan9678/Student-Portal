...
<body>
    ...
    <!-- table -->
        <div class="tbl"> 
        <div class="view">
        <button class="btn" style="width: 224px;height: 47px;"><a href="/teacher/html links/grade-view.php">View Marks</a></button>
        </div>
            ...
            <tbody>
              <?php  
               ...
               <tr>
                  ...
                  <form action="grade-process.php" method="post">
                      <div>
                        <td>  
                      ...
                      <div>
                        <td>  
                          ...
                          <input type="number" id="obtained" name="obtained">
                        </td>
                      </div>
                      <div>
                        <td>  
