...
<body>
    ...
    <!-- table -->
        <div class="tbl"> 
        <div class="view">
        <button class="btn" style="width: 224px;height: 47px;"><a href="/teacher/html links/attend.php">Edit Attendance</a></button>
        </div>
            ...
            <tbody>
              <?php  
                  ...
                  $query = "SELECT * FROM attendance
                            JOIN user ON attendance.regdno = user.regdno";
